...
class product {
    ...
    public function insert_product()
    {
        ...
        $query = "INSERT INTO `tbl_product`( `product_name`, `category_id`, `brand_id`, `color_id`, `product_price`, `product_price_new`, `product_desc`, `product_img`) 
        VALUES ('$product_name','$category_id','$brand_id','$color_id','$product_price','$product_price_new','$product_desc','$product_img')";
